...
export const metadata = {
  ...
  description: 'Listen on Spotify, Apple Podcasts, YouTube, or RSS. Pick your station.'
}
  ...
  return (
    <main className="relative">
      <PageHeader
        ...
        title="PICK YOUR"
        accent="STATION."
        lead="Every long-form interview, plus the blog. Subscribe once and the new episode lands wherever you already listen."
      />
      ...
      <section className="container-x pb-24 lg:pb-32">
        ...
        <div className="mt-16 max-w-2xl border-t border-border pt-10">
          ...
          <p className="mt-6 text-base text-mute">
            For show notes, blog posts between episodes, and the occasional unpublished cut, the
